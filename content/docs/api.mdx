...
| 語言 | 倉庫 | 安裝 |
|---|---|---|
| Go | [FurCDN/FurCDN-API-Go](https://github.com/FurCDN/FurCDN-API-Go) | `go get github.com/FurCDN/FurCDN-API-Go@v0.1.0` |
| Java | [FurCDN/FurCDN-API-Java](https://github.com/FurCDN/FurCDN-API-Java) | JitPack:`com.github.FurCDN:FurCDN-API-Java:0.1.0` |
| Kotlin | [FurCDN/FurCDN-API-Kotlin](https://github.com/FurCDN/FurCDN-API-Kotlin) | JitPack:`com.github.FurCDN:FurCDN-API-Kotlin:0.1.0` |
